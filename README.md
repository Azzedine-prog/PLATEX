...
## What you get
- A LinkedIn-inspired, modern Qt editor with tabs for open files, a left-hand **Project Files** browser, menu bar shortcuts, **project folders**, a one-click **Compile PDF** button, **syntax highlighting**, and a built-in split-view PDF preview (no external viewer pops up unless you ask). When compilation fails, the preview pane flips to a readable log with inline error highlights in the editor.
